...
import delimited "C:\Users\benjamin.montmartin\Desktop\Etude UFC 2023\Part III\radiologistes.csv", clear
rename genre gender
...
keep if strpos(codeccamdelacte, "ZBQK0020")
tab codeccamdelacte
...
replace mp=24.7 if convention==1 & optioncontratdaccèsauxsoins=="false"
...
replace prixmoyen=24.7 if prixmoyen==0
replace prixmoyen=24.7 if prixmoyen<24.7
...
gen exessr=((prixmoyen-24.7)/24.7)*100
...
by dep: gen depmoyen=[(PrixMoyen-24.7)/24.7]*100
drop PrixMoyen
rename Prix PrixMoyen
gen depmoyen_F=[(PF-24.7)/24.7]*100
...
by dep: gen depmoyenS2=[(PrixMoyenS2-24.7)/24.7]*100
by dep: egen dpS2=mean(depmoyenS2)
drop PrixMoyenS2
rename PrixS2 PrixMoyenS2
drop depmoyenS2
rename dpS2 depmoyenS2
gen depmoyen_FS2=[(PFS2-24.7)/24.7]*100
