...
keep if codeccamdelacte=="CSC" |codeccamdelacte=="CSC+MCC"

replace mp=51 if convention==1 & optioncontratdaccèsauxsoins=="false"
...
replace prixmoyen=51 if prixmoyen==0
replace prixmoyen=51 if prixmoyen<51
...
gen exessr=((prixmoyen-51)/51)*100
...
by dep: gen depmoyen=[(PrixMoyen-51)/51]*100
drop PrixMoyen
rename Prix PrixMoyen
gen depmoyen_F=[(PF-51)/51]*100
