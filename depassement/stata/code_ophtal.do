...
import delimited "C:\Users\benjamin.montmartin\Desktop\Etude UFC 2023\Part III\ophtal.csv", clear
rename genre gender
...
keep if codeccamdelacte=="CS_" |codeccamdelacte=="CS_+MPC"|codeccamdelacte=="CS_+MPC+MCS"
...
//gen exess=exessr
//gen double ty=round(exess,.001)
//drop exess
//rename ty exess
//replace exess=. if exess==0
//by dep: egen deppratiqué=mean(exess)
//replace deppratiqué=0 if deppratiqué==.
//egen deppratiqué_F=mean(exess)
