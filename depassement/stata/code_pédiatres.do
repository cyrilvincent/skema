...
//import delimited "C:\Users\benjamin.montmartin\Desktop\Etude UFC 2023\Part III\pediatres.csv", clear
import delimited "C:\Users\conta\git-CVC\Skema\Part III\pediatres.csv", clear
rename genre gender
...
keep if codeccamdelacte=="CS_+MEP+NFP" |codeccamdelacte=="CS_+NFP"


replace mp=37 if codeccamdelacte=="CS_+MEP+NFP" &  convention==1 & optioncontratdaccèsauxsoins=="false"
...
gen exessr=((prixmoyen-37)/37)*100
...
by dep: gen depmoyen=[(PrixMoyen-37)/37]*100
drop PrixMoyen
rename Prix PrixMoyen
gen depmoyen_F=[(PF-37)/37]*100
