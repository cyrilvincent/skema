...
import datetime
try:
	print(f"datetime=={datetime.__version__}")
except AttributeError:
	pass
import difflib
try:
	print(f"difflib=={difflib.__version__}")
except AttributeError:
	pass
import json
try:
...
import ssl
try:
	print(f"ssl=={ssl.__version__}")
except AttributeError:
	pass
import threading
try:
	print(f"threading=={threading.__version__}")
except AttributeError:
	pass
import time
try:
...
import typing
try:
	print(f"typing=={typing.__version__}")
except AttributeError:
	pass
import unidecode
try:
...
import unittest
try:
	print(f"unittest=={unittest.__version__}")
except AttributeError:
	pass
import urllib
try:
	print(f"urllib=={urllib.__version__}")
except AttributeError:
	pass
