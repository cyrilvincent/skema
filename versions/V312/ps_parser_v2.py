...
if __name__ == '__main__':
    ...
    # Juin 2025
    # V1 data/ps/plasticien-00-00.csv -n -t 834/852: 98% [645, 7, 33, 7, 0, 0, 78, 31, 25, 2, 5, 1]
    # V2 data/ps/plasticien-00-00.csv -n -t 735/852: 86% [548, 6, 30, 7, 4, 0, 57, 36, 19, 1, 12, 15]
    # V2 double coords 739/852: 87% [555, 6, 30, 7, 5, 0, 55, 37, 17, 1, 10, 16]
    # V1 sans len rule8 834/852 [645, 7, 33, 7, 0, 0, 78, 31, 25, 2, 5, 1] rien ne change
    # rule1 PAr + rule2 Personne => 18 dans rule2
    # Placé en dernier 1 seul ! => je vire
